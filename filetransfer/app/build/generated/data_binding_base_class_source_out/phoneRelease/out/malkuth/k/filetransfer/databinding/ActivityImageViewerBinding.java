...
import malkuth.k.filetransfer.util.ZoomImageView;
...
public final class ActivityImageViewerBinding implements ViewBinding {
  ...
  private ActivityImageViewerBinding(@NonNull LinearLayout rootView, @NonNull Button btnBack,
      @NonNull Button btnFit, @NonNull Button btnZoomIn, @NonNull Button btnZoomOut,
      @NonNull ZoomImageView image) {
  ...
  public static ActivityImageViewerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_fit;
      Button btnFit = ViewBindings.findChildViewById(rootView, id);
      if (btnFit == null) {
        break missingId;
      }
      ...
      return new ActivityImageViewerBinding((LinearLayout) rootView, btnBack, btnFit, btnZoomIn,
          btnZoomOut, image);
    }
